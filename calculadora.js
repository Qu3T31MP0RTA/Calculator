let equalPressed = 0;
let buttonIpunt = document.querySelectorAll(".button");
let input = document.getElementById("input");
let equal = document.getElementById("equal");
let clear = document.getElementById("clear");
let error = document.getElementById("erase");
...
buttonIpunt.forEach((buttonClass) => {
...
equal.addEventListener("click", () => {
    ...
    try {
        ...
        addToHistory(expresion, input.value)
    }
    catch (error) {
